                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('typeprix.update', 'test') }}" method="post">
                                                    {{ method_field('patch') }}
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="nom" class="mr-sm-2">Type prix
                                                                :</label>
                                ...
                                <div class="modal fade" id="delete{{ $type_prix->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('typeprix.destroy','test') }}" method="post">
                                                    {{ method_field('Delete') }}
                                                    @csrf
                                                    Etes sûr du processus de suppression
                                                    <label for="typeprix" class="mr-sm-2">type prixcertif
                                                        :</label>
                                                    <input id="id" type="text" name="typeprix"
                                                        class="form-control" value="{{ $type_prix->libelle }}">
                                                    <input id="id" type="hidden" name="id"
                                                        class="form-control" value="{{ $type_prix->id }}">
                                                    <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- add_form -->
                    <form action="{{ route('typeprix.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <label for="libelle" class="mr-sm-2">libelle 
                                    :</label>
                                <input id="libelle" type="text" name="libelle" class="form-control" placeholder="100dt" required>
                            </div>
