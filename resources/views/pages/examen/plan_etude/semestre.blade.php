                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#edit{{ $semestre->id }}" title="modifier">modifier <i
                                                class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete{{ $semestre->id }}" title="supprimer">supprimer <i
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('semestre.update', 'test') }}" method="post">
                                                    {{ method_field('patch') }}
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="nom" class="mr-sm-2">Semestre
                                                                :</label>
                                                            <input id="libelle" type="text" name="libelle"
                                                                class="form-control" value="{{ $semestre->libelle }}"
                                                                required>
                                                            <input id="id" type="hidden" name="id"
                                                                class="form-control" value="{{ $semestre->id }}">
                                                        </div>
                                                    </div>
                                                    <br><br>
                                ...
                                <div class="modal fade" id="delete{{ $semestre->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('semestre.destroy','test') }}" method="post">
                                                    {{ method_field('Delete') }}
                                                    @csrf
                                                    Etes sûr du processus de suppression
                                                    <label for="annee_universitaire" class="mr-sm-2">Semestre
                                                        :</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('semestre.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="libelle" class="mr-sm-2">Semestre
                                    :</label>
                                <input id="libelle" type="text" name="libelle" class="form-control" placeholder="2022-2023" required>
                            </div>
                        </div>
                        <br><br>
                </div>
